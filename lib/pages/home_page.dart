...
import 'package:aplikasi_laundry/models/jenis_laundry.dart';
import 'package:aplikasi_laundry/models/jenis_pakaian.dart';
import 'package:aplikasi_laundry/pages/pembayaran_page.dart';
...
class _HomePageState extends State<HomePage> {
 ...
 List<JenisPakaian> jenisPakaian = [
   ...
   JenisPakaian(jenis: 'Celana Dalam', harga: 2000, status: false),
   JenisPakaian(jenis: 'Bra', harga: 2000, status: false),
